...
function ContactForm(props: ContactFormProps) {
  ...
  function sendForm(data) {
    ...
    // Si todo está bien,
    setStatusMessage("Mensaje enviado, gracias por ayudar a encontrar una mascota!");
    setStatusOpen(true);
    ...
    <div>
      <div className={`${css.root} `}>
        ...
        <form className={css.form} onSubmit={handleSubmit(sendForm)}>
          <TextField style="black" type="text" name="nombre" register={register}>
            NOMBRE
          </TextField>
          <TextField style="black" type="tel" name="telefono" register={register}>
            TELEFONO
          </TextField>
