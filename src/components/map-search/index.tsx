...
type MapSearchProps = {
	...
	initialCoords?: Coords; //  prop para pasarle coordenadas ya existente y el mapa inicie ahi (editReport)
};
...
function MapSearch(props: MapSearchProps) {
	...
	const [coords, setCoords] = useState<Coords>({
		lat: initialCoords?.lat ?? -34.6037,
		lng: initialCoords?.lng ?? -58.3816,
	});
	useEffect(() => {
		if (initialCoords) {
