...
function EditReport() {
	...
	useEffect(() => {
		if (petToEdit) {
			reset({
				name: petToEdit.name, // Asigna el nombre de la mascota
				// Agrega otros campos si es necesario
			});
			setImage(petToEdit.imgUrl); // Asigna la imagen para mostrarla
			setLastCoords({ lat: petToEdit.lat, lng: petToEdit.lng });
		}
	}, []);
			...
			<div className={css.root}>
				<div className={css["text-container"]}>
					...
					<Text variant="subtitle">
						{" "}
						Cambia la información de tu mascota que desees
					</Text>
				</div>
				<form
					id="my-form"
				...
				>
					...
					<MapSearch lastCoords={handleCoordsChange} initialCoords={lastCoords}>
				...
				<div className={css.buttons}>
					...
					<Button style="red" type="button" onClick={deleteReport}>
						Eliminar reporte
					</Button>
					<Button
						style="gray"
